...
; #INDEX# =======================================================================================================================
;						[  Active Directory "Function Library" (nicolas RISTOVSKI) ; 30/01/2018  ]
			...
			Switch $oProperty.ADsType
				...
				Case $ADSTYPE_LARGE_INTEGER
					If $sPropertyName = "pwdLastSet" Or $sPropertyName = "accountExpires" Or $sPropertyName = "lastLogonTimestamp" Or $sPropertyName = "badPasswordTime" Or $sPropertyName = "lastLogon" Or _
							$sPropertyName = "lockoutTime" Or $sPropertyName = "ms-Mcs-AdmPwdExpirationTime" Then
...
Func _AD_VersionInfo()
    Local $aol_versioninfo[9] = [8, "V", 1, 4, 7, "30/01/2018", "AU3 v. 3.3.12.0", "Nicolas RISTOVSKI", "DSEM/UTA69"]
	;Local $aOL_VersionInfo[9] = [8, "V", 1, 4, 7.0, "20170418", "3.3.12.0", "Jonathan Clelland, water", "feeks, KenE, Sundance, supersonic, Talder, Joe2010, Suba, Ethan Turk, Jerold Schulman, Stephane, card0384, neutro"]
